import { Component, Element, h, Method, Prop, Build, State } from "@stencil/core";
...
export class CalciteButton {
  ...
  render() {
    ...
    const contentEl = (h("span", { class: CSS.content },
      h("slot", null)));
    return (h(Tag, Object.assign({}, attributes, { class: { [CSS_UTILITY.rtl]: dir === "rtl", [CSS.contentSlotted]: this.hasContent }, disabled: this.disabled, onClick: this.handleClick, ref: (el) => (this.childEl = el), tabIndex: this.disabled ? -1 : null }),
