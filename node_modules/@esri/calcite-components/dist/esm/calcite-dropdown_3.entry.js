...
import { g as getElementDir, C as CSS_UTILITY, f as focusElement, d as getElementProp, b as getAttributes } from './dom-f4d290e3.js';
import { C as CSS$2, u as updatePopper, c as createPopper } from './popper-96d586f5.js';
...
const CalciteDropdownItem = class {
  ...
  render() {
    ...
    return (h(Host, { "aria-checked": itemAria, role: itemRole, tabindex: "0" }, h("div", { class: {
      ...
      } }, this.selectionMode === "multi" ? (h("calcite-icon", { class: "dropdown-item-check-icon", icon: "check", scale: "s" })) : null, contentEl)));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
