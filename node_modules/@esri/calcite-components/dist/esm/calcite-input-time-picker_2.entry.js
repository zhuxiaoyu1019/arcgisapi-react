...
import { g as getKey, n as numberKeys, i as isSpacebarKey, a as isActivationKey } from './key-08490002.js';
import { i as isValidNumber } from './number-1331880b.js';
...
const CalciteTimePicker = class {
  ...
  render() {
    ...
    return (h(Host, null, h("div", { class: CSS.timePicker }, h("div", { role: "group" }, h("span", { "aria-label": this.intlHourUp, class: {
        ...
        [CSS.input]: true,
        [CSS.hour]: true
      }, onBlur: this.hourBlurHandler, onFocus: this.focusHandler, onKeyDown: this.hourKeyDownHandler, ref: (el) => (this.hourEl = el), role: "spinbutton", tabIndex: 0 }, this.getDisplayHour()), h("span", { "aria-label": this.intlHourDown, class: {
        [CSS.button]: true,
