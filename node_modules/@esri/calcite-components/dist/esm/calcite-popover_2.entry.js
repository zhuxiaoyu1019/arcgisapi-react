import { r as registerInstance, c as createEvent, f as forceUpdate, h, H as Host, g as getElement } from './index-aa8afca4.js';
import { d as defaultOffsetDistance, u as updatePopper, c as createPopper, C as CSS$1 } from './popper-96d586f5.js';
import { g as guid } from './guid-09142681.js';
import { q as queryElementRoots, g as getElementDir, C as CSS_UTILITY, i as queryElementsRoots } from './dom-f4d290e3.js';
...
const CalcitePopover = class {
  ...
  renderCloseButton() {
    ...
    return closeButton ? (h("calcite-action", { class: CSS.closeButton, onClick: this.hide, ref: (closeButtonEl) => (this.closeButtonEl = closeButtonEl), text: intlClose }, h("calcite-icon", { icon: "x", scale: "m" }))) : null;
  }
  renderHeader() {
