...
import { f as focusElement, g as getElementDir, a as getThemeName } from './dom-f4d290e3.js';
...
const CalciteColorPicker = class {
  constructor(hostRef) {
    ...
    this.renderChannel = (value, index, label, ariaLabel) => (h("calcite-input", { "aria-label": ariaLabel, class: CSS$2.channel, "data-channel-index": index, numberButtonType: "none", onCalciteInputChange: this.handleChannelChange, onCalciteInputInput: this.handleChannelInput, prefixText: label, scale: "s", type: "number", value: value === null || value === void 0 ? void 0 : value.toString() }));
    this.deleteColor = () => {
  ...
  render() {
    ...
    return (h("div", { class: CSS$2.container }, h("div", { class: CSS$2.colorFieldAndSliderWrap }, h("canvas", { class: {
      ...
      } }, intlHex), h("calcite-color-picker-hex-input", { allowEmpty: allowEmpty, class: CSS$2.control, dir: elementDir, onCalciteColorPickerHexInputChange: this.handleHexInputChange, ref: this.storeHexInputRef, scale: hexInputScale, value: selectedColorInHex }))), hideChannels ? null : (h("calcite-tabs", { class: {
        [CSS$2.colorModeContainer]: true,
        [CSS$2.splitSection]: true
      }, dir: elementDir }, h("calcite-tab-nav", { slot: "tab-nav" }, this.renderChannelsTabTitle("rgb"), this.renderChannelsTabTitle("hsv")), this.renderChannelsTab("rgb"), this.renderChannelsTab("hsv"))))), hideSaved ? null : (h("div", { class: { [CSS$2.savedColorsSection]: true, [CSS$2.section]: true } }, h("div", { class: CSS$2.header }, h("label", null, intlSaved), h("div", { class: CSS$2.savedColorsButtons }, h("calcite-button", { appearance: "transparent", "aria-label": intlDeleteColor, class: CSS$2.deleteColor, color: "neutral", disabled: noColor, iconStart: "minus", onClick: this.deleteColor, scale: scale }), h("calcite-button", { appearance: "transparent", "aria-label": intlSaveColor, class: CSS$2.saveColor, color: "neutral", disabled: noColor, iconStart: "plus", onClick: this.saveColor, scale: scale }))), savedColors.length > 0 ? (h("div", { class: CSS$2.savedColors }, [
...
const CalciteColorPickerHexInput = class {
  ...
  render() {
    ...
    const elementDir = getElementDir(el);
    return (h("div", { class: CSS$1.container }, h("calcite-input", { "aria-label": intlHex, class: CSS$1.input, dir: elementDir, onCalciteInputBlur: this.onCalciteInputBlur, onChange: this.onInputChange, prefixText: "#", ref: this.storeInputRef, scale: "s", value: hexInputValue }), hexInputValue ? (h("calcite-color-picker-swatch", { active: true, class: CSS$1.preview, color: `#${hexInputValue}`, scale: "s" })) : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
