import { r as registerInstance, c as createEvent, h, F as Fragment, g as getElement, H as Host } from './index-aa8afca4.js';
...
import { n as nodeListToArray, g as getElementDir, d as getElementProp, C as CSS_UTILITY } from './dom-f4d290e3.js';
import { g as getKey } from './key-08490002.js';
import { u as updatePopper, c as createPopper, C as CSS$2 } from './popper-96d586f5.js';
...
const CalciteCombobox = class {
  ...
  renderPopperContainer() {
    ...
    return (h("div", { "aria-hidden": "true", class: { "popper-container": true, "popper-container--active": open }, ref: setMenuEl }, h("div", { class: classes, ref: setListContainerEl, style: style }, h("ul", { class: { list: true, "list--hide": hideList } }, h("slot", null)))));
  }
  renderIconStart() {
  ...
  render() {
    ...
    return (h(Fragment, null, h("div", { "aria-autocomplete": "list", "aria-expanded": open.toString(), "aria-haspopup": "listbox", "aria-labelledby": labelId, "aria-owns": guid, class: {
        wrapper: true,
        "wrapper--active": open,
...
const CalciteComboboxItem = class {
  ...
  render() {
    ...
    return (h(Host, { "aria-hidden": "true" }, h("div", { class: `scale--${this.scale}` }, h("li", { class: classes, id: this.guid, onClick: this.itemClickHandler }, this.renderIcon(this.scale, isSingleSelect), h("span", { class: CSS$1.title }, this.textLabel)), this.renderChildren())));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
