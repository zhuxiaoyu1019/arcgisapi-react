import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, F as Fragment } from './index-aa8afca4.js';
import { g as guid } from './guid-09142681.js';
import { n as nodeListToArray, g as getElementDir, j as filterDirectChildren } from './dom-f4d290e3.js';
...
const CalciteTabTitle = class {
  ...
  render() {
    ...
    return (h(Host, { "aria-controls": this.controls, "aria-expanded": this.active.toString(), id: id, role: "tab", tabindex: this.disabled ? "-1" : "0" }, h(Tag, { class: { container: true, "container--has-text": this.hasText, rtl: dir === "rtl" } }, this.iconStart ? iconStartEl : null, h("slot", null), this.iconEnd ? iconEndEl : null)));
  }
