import { r as registerInstance, h, F as Fragment } from './index-aa8afca4.js';
...
const CalciteTile = class {
  ...
  render() {
    return (h(Fragment, null, this.href ? (h("calcite-link", { href: this.href }, this.renderTile())) : (this.renderTile())));
  }
};
