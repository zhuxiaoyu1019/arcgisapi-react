...
import { f as focusElement, g as getElementDir } from './dom-f4d290e3.js';
...
const CalciteFab = class {
  ...
  render() {
    ...
    return (h("calcite-button", { appearance: appearance, "aria-label": label, class: CSS.button, color: color, dir: dir, disabled: disabled, iconStart: icon, loading: loading, ref: (buttonEl) => {
