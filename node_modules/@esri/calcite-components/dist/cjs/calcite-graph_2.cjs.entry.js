...
const CalciteSlider = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { id: id }, index.h("div", { class: { container: true, "container--range": this.isRange } }, this.renderGraph(), index.h("div", { class: "track" }, index.h("div", { class: "track__range", onMouseDown: () => this.dragStart("minMaxValue"), onTouchStart: (e) => this.dragStart("minMaxValue", e), style: { left, right } }), index.h("div", { class: "ticks" }, this.tickValues.map((tick) => (index.h("span", { class: {
        tick: true,
