...
const CalciteBlock = class {
  ...
  render() {
    ...
    const headerContent = (index.h("header", { class: CSS$1.header }, hasIcon ? (index.h("div", { class: CSS$1.icon }, index.h("slot", { name: SLOTS.icon }))) : null, index.h("div", { class: CSS$1.title }, index.h(CalciteHeading.CalciteHeading, { class: CSS$1.heading, level: headingLevel || HEADING_LEVEL }, heading), summary ? index.h("div", { class: CSS$1.summary }, summary) : null)));
    const hasControl = !!dom.getSlotted(el, SLOTS.control);
    const collapseIcon = open ? ICONS$1.opened : ICONS$1.closed;
    const headerNode = (index.h("div", { class: CSS$1.headerContainer }, this.dragHandle ? index.h("calcite-handle", null) : null, collapsible ? (index.h("button", { "aria-expanded": collapsible ? open.toString() : null, "aria-label": toggleLabel, class: CSS$1.toggle, onClick: this.onHeaderClick, title: toggleLabel }, headerContent, !hasControl ? (index.h("calcite-icon", { "aria-hidden": "true", class: CSS$1.toggleIcon, icon: collapseIcon, scale: "s" })) : null)) : (headerContent), loading ? (index.h("calcite-loader", { inline: true, "is-active": true, label: intlLoading })) : hasControl ? (index.h("div", { class: CSS$1.controlContainer }, index.h("slot", { name: SLOTS.control }))) : null));
...
const CalciteBlockSection = class {
  ...
  render() {
    ...
    const headerNode = toggleDisplay === "switch" ? (index.h("label", { "aria-label": toggleLabel, class: {
      ...
      }, onKeyDown: this.handleHeaderLabelKeyDown, tabIndex: 0, title: toggleLabel }, index.h("span", { class: CSS.toggleSwitchText }, text), index.h("calcite-switch", { onCalciteSwitchChange: this.toggleSection, scale: "s", switched: open, tabIndex: -1 }))) : (index.h("button", { "aria-label": toggleLabel, class: {
