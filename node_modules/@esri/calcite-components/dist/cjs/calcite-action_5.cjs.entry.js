...
const CalciteActionGroup = class {
  ...
  renderMenu() {
    ...
    return hasMenuItems ? (index.h("calcite-action-menu", { expanded: expanded, flipPlacements: ["left", "right"], label: intlMore || TEXT$1.more, onCalciteActionMenuOpenChange: this.setMenuOpen, open: menuOpen, placement: "leading-start" }, index.h("slot", { name: SLOTS$2.menuActions }), this.renderTooltip())) : null;
  }
  render() {
...
const CalciteActionMenu = class {
  ...
  renderMenuItems() {
    ...
    return (index.h("calcite-popover", { disablePointer: true, label: label, open: open, overlayPositioning: overlayPositioning, placement: placement, referenceElement: menuButtonEl }, index.h("div", { "aria-activedescendant": activeDescendantId, "aria-labelledby": menuButtonId, class: CSS$1.menu, id: menuId, onKeyDown: this.menuActionsContainerKeyDown, onKeyUp: this.menuActionsContainerKeyUp, ref: (el) => (this.menuEl = el), role: "menu", tabIndex: -1 }, index.h("slot", null))));
  }
  render() {
    return (index.h(index.Fragment, null, this.renderMenuButton(), this.renderMenuItems(), index.h("slot", { name: SLOTS$1.tooltip })));
  }
  getAssignedElements() {
