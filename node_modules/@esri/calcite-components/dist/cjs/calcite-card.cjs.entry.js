...
const CalciteCard = class {
  ...
  renderCheckbox() {
    ...
    return (index.h("label", { "aria-label": checkboxLabel, class: CSS.checkboxWrapper, onClick: this.cardSelectClick, onKeyDown: this.cardSelectKeyDown, title: checkboxLabel }, index.h("calcite-checkbox", { checked: this.selected })));
  }
  renderHeader() {
