...
const CalciteChip = class {
  ...
  render() {
    ...
    return (index.h("div", { class: { container: true, [dom.CSS_UTILITY.rtl]: dir === "rtl" } }, this.renderChipImage(), this.icon ? iconEl : null, index.h("span", { id: this.guid }, index.h("slot", null)), this.dismissible ? closeButton : null));
  }
