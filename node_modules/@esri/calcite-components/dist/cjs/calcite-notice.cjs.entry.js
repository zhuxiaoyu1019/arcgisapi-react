...
const CalciteNotice = class {
  ...
  render() {
    ...
    return (index.h("div", { class: { container: true, [dom.CSS_UTILITY.rtl]: dir === "rtl" } }, this.requestedIcon ? (index.h("div", { class: "notice-icon" }, index.h("calcite-icon", { icon: this.requestedIcon, scale: "m" }))) : null, index.h("div", { class: "notice-content" }, index.h("slot", { name: SLOTS.title }), index.h("slot", { name: SLOTS.message }), index.h("slot", { name: SLOTS.link })), this.dismissible ? closeButton : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
