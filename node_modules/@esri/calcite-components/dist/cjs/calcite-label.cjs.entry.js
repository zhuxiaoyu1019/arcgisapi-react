...
const CalciteLabel = class {
  constructor(hostRef) {
    ...
    this.handleCalciteHtmlForClicks = (target) => {
      ...
      const inputForThisLabel = dom.queryElementRoots(this.el, `#${this.for}`);
  ...
  render() {
    ...
    return (index.h("label", Object.assign({}, attributes, { class: { [dom.CSS_UTILITY.rtl]: dir === "rtl" } }), index.h("slot", null)));
  }
