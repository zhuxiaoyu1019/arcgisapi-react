...
const CalciteModal = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-describedby": this.contentId, "aria-labelledby": this.titleId, "aria-modal": "true", role: "dialog" }, index.h("calcite-scrim", { class: "scrim" }), this.renderStyle(), index.h("div", { class: { modal: true, [dom.CSS_UTILITY.rtl]: dir === "rtl" } }, index.h("div", { "data-focus-fence": true, onFocus: this.focusLastElement, tabindex: "0" }), index.h("div", { class: "header" }, this.renderCloseButton(), index.h("header", { class: "title" }, index.h("slot", { name: "header" }))), index.h("div", { class: {
        content: true,
  ...
  renderFooter() {
    return this.hasFooter ? (index.h("div", { class: "footer" }, index.h("span", { class: "back" }, index.h("slot", { name: "back" })), index.h("span", { class: "secondary" }, index.h("slot", { name: "secondary" })), index.h("span", { class: "primary" }, index.h("slot", { name: "primary" })))) : null;
  }
  renderCloseButton() {
    return !this.disableCloseButton ? (index.h("button", { "aria-label": this.intlClose, class: "close", onClick: this.close, ref: (el) => (this.closeButtonEl = el), title: this.intlClose }, index.h("calcite-icon", { icon: "x", scale: this.scale === "s" ? "s" : "l" }))) : null;
  }
  renderStyle() {
  ...
  open() {
    ...
    this.active = true;
    const titleEl = dom.getSlotted(this.el, "header");
    const contentEl = dom.getSlotted(this.el, "content");
