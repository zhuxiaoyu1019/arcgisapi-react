...
const CalciteTabTitle = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-controls": this.controls, "aria-expanded": this.active.toString(), id: id, role: "tab", tabindex: this.disabled ? "-1" : "0" }, index.h(Tag, { class: { container: true, "container--has-text": this.hasText, rtl: dir === "rtl" } }, this.iconStart ? iconStartEl : null, index.h("slot", null), this.iconEnd ? iconEndEl : null)));
  }
...
const CalciteTabs = class {
  ...
  //--------------------------------------------------------------------------
  render() {
    return (index.h(index.Fragment, null, index.h("slot", { name: "tab-nav" }), index.h("section", null, index.h("slot", null))));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
